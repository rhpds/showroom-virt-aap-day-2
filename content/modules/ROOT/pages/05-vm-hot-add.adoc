...
. When the job completes, head to the OpenShift UI dashboard and view the details of the Virtual Machines. You should see that the new size `u1.2xmedium` is now being used.
