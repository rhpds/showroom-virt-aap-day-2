...
. After making and saving the changes, ensure you commit and push them to your Gitea repository.
+
. Head back to the AAP Dashboard UI, go to the **Automation Execution -> Templates**, select the `Stop VMs` Job Template and select the pencil icon image:../assets/images/pencil.png[width=20px] to edit the template.
+
...
image::../assets/images/stop_vms_multiple.png[Stopping the VMs]
