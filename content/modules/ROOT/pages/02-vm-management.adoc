...
----
+
. Head back to the AAP Dashboard UI, go to the **Automation Execution -> Templates**, select the `Stop VMs` Job Template and select the pencil icon image:../assets/images/pencil.png[] to edit the template.
+
