...
[[vm_mgmt_power]]
== Automated VM Management (Stop, Start, Restart Guest VMs)
...
To being, we’ll perform some common VM lifecycle actions such as stopping, starting, and restarting all VMs in a given namespace. These tasks are designed to demonstrate how the automation behind these actions is structured.
...
[[vm_mgmt_patch]]
== Automated VM Management (Patching your VMs)
...
image::module01-day-to-day/63-patch_vm.png[title="Patch VM", link=self, window=blank, width=100%]
...
+
image::module01-day-to-day/64-patch_complete.png[title="Patching Complete", link=self, window=blank, width=100%]
+
...
image::module01-day-to-day/65-patch_details.png[title="Patch Details", link=self, window=blank, width=100%]

[[vm_mgmt_hp]]
== Automated VM Management (Hot-Plugging CPU and Memory Resources)
...
image::module01-day-to-day/66-vm_details.png[title="VM Details", link=self, window=blank, width=100%]
...
+
image::module01-day-to-day/67-create_template.png[title="Create Job Template", link=self, window=blank, width=100%]
+
...
+
image::module01-day-to-day/68-create_hotadd_template.png[title="Create HotAdd Template", link=self, window=blank, width=100%]
+
...
+
image::module01-day-to-day/69-hotadd_template_success.png[title="HotAdd Template Success", link=self, window=blank, width=100%]
+
...
image::module01-day-to-day/70-vm_modified_instancetype.png[title="VM InstanceType Modified ", link=self, window=blank, width=100%]
