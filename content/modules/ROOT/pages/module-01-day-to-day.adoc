...
CAUTION: Be sure to select *htpasswd* authentication.
...
CAUTION: These Windows virtual machines will autommatically shut down after one hour of runtime, as a limitation of our Windows license.
Start them up again if need be.
